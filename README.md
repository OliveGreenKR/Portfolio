...
This system was synthesized from research dossiers (raw "Fact Unit" indexes) supplied by the user:

- `uploads/identity-narrative.md` — voice, identity, core belief
- `uploads/03-project-dx11.md` — DX11 custom physics engine (16 wks, 147 files)
- `uploads/04-project-cartapli.md` — Cartapli: Fold Quest (Steam, 98% positive)
- `uploads/06-project-badulbadul.md` — Badulbadul2 (game lab)
- `uploads/07-project-liver-donation.md` — non-technical life experience
- `uploads/08-project-badulbadul-release.md` — Wobble Wobble (Steam release)
- `uploads/09-project-1000-Kittens.md.txt` — game jam
- `uploads/26_summer_game_platform.md` — target role context (Pearl Abyss internship)
...
- `preview/` — small per-token cards rendered in the Design System tab
