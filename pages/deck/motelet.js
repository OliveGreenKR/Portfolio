...
(function buildMoteletDeck() {
  ...
  window.DECK_PARTS.motelet = {
    ...
    slides: [
      ...
      // ─── 05 곁가지 둘 — 자동 탐색기와 배틀 런타임 ───
      // 원래 두 장이었다. 둘 다 pairs 다섯짜리 목록 하나뿐인 반 장이었고,
      // 성격도 같다 — **만들었지만 이 프로젝트의 주장(계산으로 판단했다)은 아닌 것.**
      // 탐색기는 만들고 결정에 안 썼고, 런타임은 엔진이 안 정해 주는 것을 직접 정한 곁가지다.
      // 두 칸으로 세우면 한 장에 열 쌍이 들어간다.
      {
        layout: 'columns',
        section: '04 곁가지',
        title: '만들었지만 주장은 아닌 것',
        colCount: 2,
        cols: [
