...
window.ABOUT_DATA = {
  ...
  body: [
    '기획 의도를 기능 목록으로만 받아들이지 않고, 플레이어가 느낄 핵심 경험과 구현할 때의 판단 기준으로 구체화합니다. 클라이언트와 엔진의 경계를 먼저 나누기보다, 그 경험을 구현하는 데 필요한 기술부터 살핍니다.',
  ...
  strands: [
    {
      ...
      kind: 'BUILD',
      title: '만들어 보고 정하기',
      lede: '말로 설득력 있는 아이디어와 실제로 재미있는 아이디어는 다를 수 있습니다. 먼저 작동하는 형태로 만들어 직접 경험한 뒤, 더 발전시킬지 중단할지 결정합니다.',
    ...
    },
    {
      kind: 'SYSTEMS',
      title: '책임을 나누기',
      lede: '동시에 동작하는 시스템이 서로를 직접 참조하지 않도록 책임과 경계를 나눕니다.',
      examples: [
        { tag: 'Cartapli',    line: '11개 싱글톤이 동시에 동작하는 배틀씬을 시스템 간 직접 참조 0으로 구성해, 시스템을 추가해도 기존 코드를 바꾸지 않도록 했습니다.', href: '../pages/cartapli.html' },
    ...
    },
    {
      ...
      lede: '감각으로 판단할 영역과 측정할 영역을 먼저 구분합니다. 측정하기로 한 대상은 계산 모델로 옮기고, 각 변경의 영향을 분리해 설명할 수 있는 수치로 만듭니다.',
      examples: [
        { tag: 'Cartapli Mobile', line: '종이접기 코어를 5단계로 나눠 고치고 단계마다 따로 측정 — 구조로 얼마, DOTS로 얼마를 갈라 말합니다.', href: '../pages/cartapli-mobile.html' },
        { tag: 'Motelet',         line: '플레이 감각만으로 특정하기 어려운 "어느 구간이 왜 과한가"를 런타임 공식을 반영한 계산 모델로 분석했습니다.', href: '../pages/motelet.html' },
      ],
    },
    {
      kind: 'SHIP',
      title: '출시하고 운영하기',
      lede: '게임을 만드는 데서 멈추지 않고, 출시와 운영까지 직접 맡습니다.',
      examples: [
    ...
    groups: [
      {
        ...
        items: [
          ...
          { lead: 'C# (초급)',         text: '값·참조 타입과 박싱 비용을 고려한 코드 작성' },
      ...
      },
      {
        ...
        items: [
          ...
          { lead: 'SIMD',                  text: 'SIMD를 활용한 반복 연산의 벡터화' },
        ],
      },
      {
        name: '그래픽스 · 물리',
        items: [
          { lead: '렌더링 파이프라인', text: '리소스 바인딩 상태를 추적하는 렌더러 구조 설계' },
  ...
  background: {
    ...
    rows: [
      ...
      { y: '2025.07 ─ 2026.02', t: '크래프톤 게임랩 4기에서 주 단위 프로젝트 트랙과 EPIC 과정을 거쳐 Cartapli: Fold Quest를 Steam에 출시했습니다.' },
      { y: '2026.03 ─ 2026.04', t: '게임랩에서 만든 빌드를 5주 만에 Wobble Wobble로 Steam · STOVE에 동시 출시했습니다. PM과 자동화를 담당했습니다.' },
