...
window.ABOUT_DATA = {
  ...
  display: ['코드를 짜기 전에 구조를 봅니다.', '만든 뒤에는 숫자를 봅니다.'],
  displayMark: '숫자를',

  // 본문 카피 (사용자 제공 — C안: 금지어 교체본) + 이력서 자기소개 한 문장 보강
  body: [
    '플레이어 경험과 몰입을 중심으로 시스템을 설계합니다. 반복 구현과 불필요한 확인 비용을 줄여, 팀이 핵심 재미를 더 오래 고민할 수 있는 개발 환경을 만드는 것을 좋아합니다. 코드를 짜기 전에 구조를 보고, 만든 뒤에는 숫자를 보는 개발을 지향합니다.',
