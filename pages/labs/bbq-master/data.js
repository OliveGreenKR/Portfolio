...
window.BBQ_DATA = {
  ...
  hook:
    '공간을 **32³ 복셀**로 나눠 고기와 공기 사이의 **열전도**를 계산하고, ' +
    '그 결과를 **겉면 색**과 **절단면**으로 시각화했다.',
  ...
  context: {
    body:
      '스테이크를 구울 때는 겉면을 얼마나 지질지, 언제 불에서 내릴지, 화력을 어떻게 조절할지를 판단한다.',
    body2:
    ...
    tensionWhy:
      '그래서 이 PoC의 물음은 고기 굽기 게임을 만들 수 있느냐가 아니라 ' +
  ...
  field: {
    ...
    body2:
      '각 칸에는 **온도**와 **전도율**만 저장하고, ' +
      '시뮬레이션은 이웃한 칸 사이의 열 교환만 계산한다.',
  ...
  limits: [
    ...
    ['관찰 가능한 계산 방식을 우선했다',
      '병렬 처리와 GPU 계산 대신, 에디터에서 값의 흐름을 직접 확인할 수 있는 방식을 택했다.'],
    ['격자 크기가 고정이다',
