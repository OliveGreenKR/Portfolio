...
window.LANDING_DATA = {
  // 정체성 — 사용자 제공 메인·서브 문구 (2026-09-06).
  identity: {
    ...
    headline: ['사용은 단순하게,', '구조는 유연하게'],
    headlineMarkSecondLine: '구조는 유연하게', // 두 번째 줄의 형광펜 부분
    stance: [
      '플레이어 경험과 몰입을 중심으로 시스템과 데이터를 설계합니다.',
      '반복 구현과 불필요한 확인 비용을 줄여, 팀이 핵심 재미를 더 오래 고민할 수 있는 개발 환경을 만드는 것을 좋아합니다.',
    ],
  ...
  labs: [
    {
      ...
      line: '리소스의 적재·해제 판단을 재생 정책에서 분리했고, 같은 경계를 적용해 이펙트 리소스 시스템의 코어를 하루 만에 구축했다.',
    },
    {
      idx: 'L.02',
